...
We as members, contributors, and leaders pledge to make participation in the BongoPay
...
Maintainers (see [MAINTAINERS.md](MAINTAINERS.md)) are responsible for clarifying and enforcing
standards of acceptable behavior and will take appropriate, fair corrective action in response
...
RFCs) and in public spaces when an individual is representing the project.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
maintainers via the contact listed in [MAINTAINERS.md](MAINTAINERS.md) or
